...
def get_decisions_at_forks(filenames: list, nth_times: list) -> tuple:
    ab_b_or_c, b_b1b2_or_be, c_cg_or_e, e_f_or_eg = ({} for _ in range(4))
    for filename in filenames:
        ...
        e_f_or_eg[filename] = {nth_time: t.state1_before_state2('f', 'eg', time_series=t.after_exited('e', nth_time))
                               for nth_time in nth_times}
    return ab_b_or_c, b_b1b2_or_be, c_cg_or_e, e_f_or_eg
...
if __name__ == '__main__':
    ...
    ab_b_or_c, b_b1b2_or_be, c_cg_or_e, e_f_or_eg = get_decisions_at_forks(df_solver['filename'], nth_times)
